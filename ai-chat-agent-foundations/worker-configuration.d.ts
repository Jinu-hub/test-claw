/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5a47e4e1875cfa92cd0d75eda985c846)
// Runtime types generated with workerd@1.20260730.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	TwentyQuestionsAgent: DurableObjectNamespace<import("./worker/index").TwentyQuestionsAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "TwentyQuestionsAgent";
	}
