/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: e0eac3cad0f6042a90536188f7dbf4fc)
// Runtime types generated with workerd@1.20260804.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	REALITY_BUCKET: R2Bucket;
	AI: Ai;
	...
	SUGGEST_WATCH_INTENT_WORKFLOW: Workflow<Parameters<import("./src/server").SuggestWatchIntentWorkflow['run']>[0]['payload']>;
}
