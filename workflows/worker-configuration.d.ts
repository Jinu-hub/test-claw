/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9eb0ebb26a9c5994fa55a314c2d3db7d)
// Runtime types generated with workerd@1.20260801.1 2026-05-18 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	QuizAgent: DurableObjectNamespace<import("./worker/index").QuizAgent>;
	QUIZ_WORKFLOW: Workflow<Parameters<import("./worker/index").QuizWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "QuizAgent";
	}
